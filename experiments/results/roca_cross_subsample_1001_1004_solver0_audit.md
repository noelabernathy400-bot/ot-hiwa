...
- Runs: 4
- Geometry selector accuracy (evaluation only): 0.750
- Material-conflict rejects: 0/4 (coverage 1.000)
- Geometry accuracy among non-rejected seeds (evaluation only): 0.750
