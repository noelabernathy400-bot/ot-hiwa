...
- Runs: 2
- Geometry selector accuracy (evaluation only): 0.500
- Material-conflict rejects: 0/2 (coverage 1.000)
- Geometry accuracy among non-rejected seeds (evaluation only): 0.500
